...
/**
 * [...]
 * This class is used as a controller to achieve Buy functionality 
 *
...
public class buyController
{
	...
	{
		return DbOperationHelper.retriveSaleSearchResults(Key);
	}	
	...
	public void addToCart(Map<Integer,Integer> itemIdQuantity) throws SQLException
	{
		...
		for(Map.Entry<Integer, Integer> entry : itemIdQuantity.entrySet())
		{
			...
			{
				cartObj.addCartLineItem(entry.getKey(),DbOperationHelper.getUserId(),entry.getValue(),true);
			}
		}
